...
Other options are 1) downloading a zip file with all the repository, and 2) show the raw versión in your web browser and copy the text. You can find the corresponding buttons in the git web pages. 
